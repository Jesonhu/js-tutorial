...
3. [语法提案流程](#语法提案的批准流程)
4. [ECMAScript的历史](#ecmascript-的历史)
5. [部署进度](#部署进度)
6. [Babel转码器](#babel-转码器)
7. [Traceur转码器](#traceur-转码器)
...
2015年6月，ECMAScript 6 正式通过，成为国际标准。从2000年算起，这时已经过去了15年。[BackTop](#知识点)
...
转码的时候，就执行下面的命令。\[这里之所以可以运行npm run build是因为package.json中的script指定了\]
